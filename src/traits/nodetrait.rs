...
impl<
        ...
        Embed: Fn(&mut State, ScopedState),
        ScopedTree: Fn(&mut ScopedState) -> Node<'nodes, ScopedState>,
    > OwnedScoper<'nodes, State, ScopedState, Scope, Embed, ScopedTree>
{
...
impl<
        ...
        Embed: Fn(&mut State, ScopedState),
        ScopedTree: Fn(&mut ScopedState) -> Node<'nodes, ScopedState>,
    > Debug for OwnedScoper<'nodes, State, ScopedState, Scope, Embed, ScopedTree>
{
...
impl<
        ...
        Embed: Fn(&mut State, ScopedState),
        ScopedTree: Fn(&mut ScopedState) -> Node<'nodes, ScopedState>,
    > NodeTrait<State> for OwnedScoper<'nodes, State, ScopedState, Scope, Embed, ScopedTree>
{
    fn constraints(&mut self, available_area: Area, state: &mut State) -> Option<SizeConstraints> {
