...
impl<T, Lens: Copy> Node<'_, T, Lens> {
...
impl<'nodes, T, Lens: Copy> Node<'nodes, T, Lens> {
    /// Adds padding to the node along the leading edge
    pub fn pad_leading(self, amount: f32) -> Node<'nodes, T, Lens> {
        Node {
    ...
    pub fn pad_x(self, amount: f32) -> Node<'nodes, T, Lens> {
        Node {
            inner: NodeValue::Padding {
                amounts: Padding {
                    leading: amount,
    ...
    pub fn pad_trailing(self, amount: f32) -> Node<'nodes, T, Lens> {
        Node {
            inner: NodeValue::Padding {
                amounts: Padding {
                    leading: 0.,
    ...
    pub fn pad_top(self, amount: f32) -> Node<'nodes, T, Lens> {
        Node {
            inner: NodeValue::Padding {
                amounts: Padding {
                    leading: 0.,
    ...
    pub fn pad_y(self, amount: f32) -> Node<'nodes, T, Lens> {
        Node {
            inner: NodeValue::Padding {
                amounts: Padding {
                    leading: 0.,
    ...
    pub fn pad_bottom(self, amount: f32) -> Node<'nodes, T, Lens> {
        Node {
            inner: NodeValue::Padding {
                amounts: Padding {
                    leading: 0.,
    ...
    pub fn pad(self, amount: f32) -> Node<'nodes, T, Lens> {
        Node {
            inner: NodeValue::Padding {
                amounts: Padding {
                    leading: amount,
    ...
    pub fn offset_x(self, amount: f32) -> Node<'nodes, T, Lens> {
        Node {
    ...
    /// This is an absolute offset that simply shifts nodes away from their calculated position
    /// This won't impact layout besides child nodes also being offset
    pub fn offset_y(self, amount: f32) -> Node<'nodes, T, Lens> {
        Node {
            inner: NodeValue::Offset {
                offset_x: 0.,
                offset_y: amount,
    ...
    /// This is an absolute offset that simply shifts nodes away from their calculated position
    /// This won't impact layout besides child nodes also being offset
    pub fn offset(self, offset_x: f32, offset_y: f32) -> Node<'nodes, T, Lens> {
        Node {
            inner: NodeValue::Offset {
                offset_x,
                offset_y,
    ...
    ///
    /// If you don't want a container to hug / shrink-wrap it's contents use [`Node::expand()`]
